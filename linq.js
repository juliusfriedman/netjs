(function () {
    ...
    function List(/*type, array, capacity*/) {
        ...
        capacity = 10,        // Used to create getters and setters until I have worked out a different way        
        ...
        if (arguments[0] && arguments[0] instanceof List) {
            ...
            try { //If there is a type given it may be contained in an array which is to be used as the interal array..       
                capacity += arguments[0].length;
            ...
            oType = arguments[0];
            if (arguments[1]) listArray = arguments[1];
            if (arguments[2]) capacity = arguments[2];
        }
...
Enumerable = (function () {
    ...
    //Interesting because no reordering is done, instead a new Enumerable is created which reverses the iteration of the elements...
    //Very efficent for large sets
